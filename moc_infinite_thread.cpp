...
static const uint qt_meta_data_InfiniteCountWorker[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Double, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Double, QMetaType::Double, QMetaType::Char, QMetaType::Char, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Char, QMetaType::Char, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::Int, QMetaType::QString, QMetaType::QString,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,    2,
    QMetaType::Void,
...
void InfiniteCountWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (InfiniteCountWorker::*)(double , int , int , int , int , double , double , char , char , int , int , int , int , int , int , char , char , int , int , int , int , int , int , QString , QString );
...
QT_INIT_METAOBJECT const QMetaObject InfiniteCountWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_InfiniteCountWorker.data,
      qt_meta_data_InfiniteCountWorker,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void InfiniteCountWorker::updateInfiniteCount(double _t1, int _t2, int _t3, int _t4, int _t5, double _t6, double _t7, char _t8, char _t9, int _t10, int _t11, int _t12, int _t13, int _t14, int _t15, char _t16, char _t17, int _t18, int _t19, int _t20, int _t21, int _t22, int _t23, QString _t24, QString _t25)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)), const_cast<void*>(reinterpret_cast<const void*>(&_t4)), const_cast<void*>(reinterpret_cast<const void*>(&_t5)), const_cast<void*>(reinterpret_cast<const void*>(&_t6)), const_cast<void*>(reinterpret_cast<const void*>(&_t7)), const_cast<void*>(reinterpret_cast<const void*>(&_t8)), const_cast<void*>(reinterpret_cast<const void*>(&_t9)), const_cast<void*>(reinterpret_cast<const void*>(&_t10)), const_cast<void*>(reinterpret_cast<const void*>(&_t11)), const_cast<void*>(reinterpret_cast<const void*>(&_t12)), const_cast<void*>(reinterpret_cast<const void*>(&_t13)), const_cast<void*>(reinterpret_cast<const void*>(&_t14)), const_cast<void*>(reinterpret_cast<const void*>(&_t15)), const_cast<void*>(reinterpret_cast<const void*>(&_t16)), const_cast<void*>(reinterpret_cast<const void*>(&_t17)), const_cast<void*>(reinterpret_cast<const void*>(&_t18)), const_cast<void*>(reinterpret_cast<const void*>(&_t19)), const_cast<void*>(reinterpret_cast<const void*>(&_t20)), const_cast<void*>(reinterpret_cast<const void*>(&_t21)), const_cast<void*>(reinterpret_cast<const void*>(&_t22)), const_cast<void*>(reinterpret_cast<const void*>(&_t23)), const_cast<void*>(reinterpret_cast<const void*>(&_t24)), const_cast<void*>(reinterpret_cast<const void*>(&_t25)) };
