...
input = encoderValue ;
 //qDebug()<<encoderValue;
 //Serial.print("encoderValue ");//z
 //Serial.println(encoderValue);
//Serial.print(" ");
//Serial.println(output); // qDebug()<< QencoderValue;
