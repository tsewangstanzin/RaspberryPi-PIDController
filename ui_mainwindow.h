...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MOUNTSTATUS->setObjectName(QStringLiteral("MOUNTSTATUS"));
        ...
        UTC_2->setObjectName(QStringLiteral("UTC_2"));
        UTC_2->setGeometry(QRect(680, 120, 121, 16));
        ams = new QLabel(centralWidget);
        ams->setObjectName(QStringLiteral("ams"));
...
"}"));
        ...
        altd->setObjectName(QStringLiteral("altd"));
        ...
        temp_lcdNumber_7->setObjectName(QStringLiteral("temp_lcdNumber_7"));
        ...
        temp_label_8->setObjectName(QStringLiteral("temp_label_8"));
